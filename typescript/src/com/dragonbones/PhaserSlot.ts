...
export class PhaserSlot extends Slot {
    ...
    override _updateFrame() {
        var frameDisplay: any = this._renderDisplay;
        if (this._display) {
            var rawDisplayData: any = this._displayIndex < this._displayDataSet.displays.length ? this._displayDataSet.displays[this._displayIndex] : null;
            var replacedDisplayData: any = this._displayIndex < this._replacedDisplayDataSet.length ? this._replacedDisplayDataSet[this._displayIndex] : null;
            var currentDisplayData: any = replacedDisplayData || rawDisplayData;
            var currentTextureData: any = currentDisplayData.texture;
