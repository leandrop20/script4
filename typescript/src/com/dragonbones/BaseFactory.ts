...
export class BaseFactory {
    ...
    private static __defaultParser: any;

    static get _defaultParser(): any { return BaseFactory.__defaultParser; }
    static set _defaultParser(value: any) { BaseFactory.__defaultParser = value; }
	...
	constructor(dataParser: any = null) {
    ...
    _buildSlots(dataPackage: any, armature: any) {
        ...
        for (let i = 0, l = slots.length; i < l; ++i) {
            ...
            var slot: any = this._generateSlot(dataPackage, slotDisplayDataSet);
            if (slot) {
    ...
    _replaceSlotDisplay(dataPackage: any, displayData: any, slot: any, displayIndex: number) {
        if (displayIndex < 0) {
     ...
     */
    parseDragonBonesData(rawData: any, dragonBonesName = null) {
	...
	* @version DragonBones 3.0
	*/
    removeDragonBonesData(dragonBonesName: string, disposeData: any = true) {
        var dragonBonesData = this._dragonBonesDataMap[dragonBonesName];
        if (dragonBonesData) {
            if (disposeData) {
     ...
     * @version DragonBones 3.0
     */
    getTextureAtlasData(dragonBonesName: string): any {
     ...
     * @version DragonBones 3.0
     */
    removeTextureAtlasData(dragonBonesName: string, disposeData: any = true) {
        var textureAtlasDataList = this._textureAtlasDataMap[dragonBonesName];
        if (textureAtlasDataList) {
            if (disposeData) {
                for (var i = 0, l = textureAtlasDataList.length; i < l; ++i) {
    ...
    _generateSlot(dataPackage: any, slotDisplayDataSet: any) {}
    _generateArmature(dataPackage: any): any {}
    _generateTextureAtlasData(textureAtlasData: any, textureAtlas: any) {}
