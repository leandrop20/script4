...
export class Animation extends BaseObject {
	...
	static _sortAnimationState(a: any, b: any) {
     ...
     * @version DragonBones 3.0
     */
    play(animationName:any = null, playTimes: number = -1) {
        var animationState = null;
        if (animationName) {
     ...
     * @version DragonBones 4.5
     */
    gotoAndPlayByTime(animationName: string, time: number = 0, playTimes: number = -1) {
        this._time = time;
     ...
     * @version DragonBones 4.5
     */
    gotoAndPlayByFrame(animationName: string, frame: number = 0, playTimes: number = -1) {
        var animationData = this._animations[animationName];
        if (animationData) {
     ...
     * @version DragonBones 4.5
     */
    gotoAndPlayByProgress(animationName: string, progress: number = 0, playTimes: number = -1) {
        var animationData = this._animations[animationName];
        if (animationData) {
     ...
     */
    gotoAndStop(animationName: string, time = 0): any {
