export class BaseObject {
    ...
    static __hashCode: number;
    static __defaultMaxCount: number;
    static __maxCountMap: any;
    static __poolsMap: any;
    ...
    static get _defaultMaxCount() {
        return (BaseObject.__defaultMaxCount) ? BaseObject.__defaultMaxCount : 5000;
    }
    static set _defaultMaxCount(value) { BaseObject.__defaultMaxCount = value; }

    static get _maxCountMap() {
        return (BaseObject.__maxCountMap) ? BaseObject.__maxCountMap : {};
    }
     ...
     * @version DragonBones 4.5
     */
    static borrowObject(objectConstructor: any) {
        var pool = BaseObject._poolsMap[String(objectConstructor)];
