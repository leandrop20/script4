...
class PDParticleSystem extends Phaser.Group
{
	constructor(settings, texture)
	{
		...
		this.durationTimer = settings.durationTimer;
		this.rate = settings.rate;
		this.rateTimer = settings.rateTimer;
	...
	updateParticle(particle, delta)
	{
        ...
        // var currentColor = Phaser.Color.hexToRGBArray();
        console.log(Phaser.Color.valueToColor(particle.sprite.tint));
        // var colorValue0 = Math.max(0, currentColor[0] + particle.deltaColor[0] * delta);
        // var colorValue1 = Math.max(0, currentColor[1] + particle.deltaColor[1] * delta);
        // var colorValue2 = Math.max(0, currentColor[2] + particle.deltaColor[2] * delta);
