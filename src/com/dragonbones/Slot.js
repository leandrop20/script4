...
export default class Slot extends TransformObject {
    ...
    _updatePivot(rawDisplayData, currentDisplayData, currentTextureData) {
    ...
    _updateMeshData(isTimelineUpdate) {
