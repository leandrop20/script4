...
export default class AnimationState extends BaseObject {
    ...
    _fadeIn(armature, clip, animationName, playTimes, position, duration, time, timeScale, fadeInTime, pausePlayhead) {
    ...
    _advanceTime(passedTime, weightLeft, index) {
        var self = this;
